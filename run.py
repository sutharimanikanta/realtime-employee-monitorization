    ...
    while cap.isOpened():
        ...
        if mesh_results.multi_face_landmarks:
            ...
            try:
                ...
                x_ang, y_ang, z_ang = angles[0] * 360, angles[1] * 360, angles[2] * 360
            ...
            if "Yawn" in event_type and (now - last_alert_time > ALERT_DEBOUNCE_SEC):
                prediction_text = "Yawning"
            elif "Blink" in event_type and (now - last_alert_time > ALERT_DEBOUNCE_SEC):
                prediction_text = "Blinking"
            else:
                prediction_text = head_text
